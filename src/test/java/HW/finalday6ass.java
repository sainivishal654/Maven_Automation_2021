...
public class finalday6ass {
    public static void main(String[] args) throws InterruptedException, IOException {
        //Kill all the
        Runtime.getRuntime().exec("killall /F /IM chrome.driver /T");
        ...
        for (int i=0; i<purchasePrice.length;i++) {
            ...
            //select month from dropdown using Select
            ...
            //select year from dropdown using Click()
