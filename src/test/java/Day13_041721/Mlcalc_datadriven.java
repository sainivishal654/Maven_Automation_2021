...
public class Mlcalc_datadriven extends Abstract_Class {
    ...
    public void Monthly_Payment_Mlcalc() throws BiffException, IOException, WriteException, InterruptedException {
...
//this is where the for loop will start to iterate through your excel data
        for (int i = 1; i < rowCount; i++) {
            ...
            String monthlyPayment = Reusable_Actions.captureText_Index(driver, "//td[@align='center']", 0, logger, "Monthly Payment");
